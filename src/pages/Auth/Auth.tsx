                    ...
                    <div className={styles.illustrationOverlay}>
                        <div className={styles.illustrationContent}>
                            ...
                            <p className={styles.illustrationText}>
                                Join thousands of premium users who trust NanoCut for their professional needs.
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className={styles.authCard}>
                        <div className={styles.brandHeader}>
                            <div className={styles.brandLogo}>
                                <img src="/favicon.png" alt="NanoCut" className={styles.logoImage} />
                            </div>
                        ...
                        <div className={styles.legalText}>
                            By continuing, you agree to our <a href="#" className={styles.legalLink}>Terms of Service</a> and <a href="#" className={styles.legalLink}>Privacy Policy</a>
                        </div>
