...
const Home: React.FC = () => {
    ...
    return (
        <>
            <SEO
                title="Home"
                description="Welcome to NanoCut V2 - a powerful, modern URL shortener to create and manage short links instantly."
                path="/"
            />
                    ...
                    <section className={styles.hero}>
                        <div className={styles.heroContent}>
                            ...
                            <p className={styles.heroText}>
                                Create branded, short URLs with powerful analytics to track your
                                audience and optimize your marketing.
                            </p>
