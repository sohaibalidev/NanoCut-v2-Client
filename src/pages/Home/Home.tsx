...
const Home: React.FC = () => {
    ...
    const handleShortenUrl = () => {
        ...
        if (!toShortenUrl.startsWith('https://') || toShortenUrl.length < 14) {
            setUrlInput('')
            // You might want to show a proper error message here
            return
        }

        sessionStorage.setItem('urlToShorten', toShortenUrl)
        if (isAuthenticated) {
                ...
                <section className={styles.hero}>
                    <div className={styles.heroContent}>
                        ...
                        <p className={styles.heroText}>
                            Create branded, short URLs with powerful analytics to track your audience and
